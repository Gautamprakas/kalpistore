...
class Customer extends MY_Controller{
	...
	public function restaurant(){
		...
		$intent["headerCss"]   = "customers/restaurant/restaurantCss";
		$intent["mainContent"] = "customers/restaurant/restaurant";
		$intent["footerJs"]    = "customers/restaurant/restaurantJs";
