                                ...
                                <caption style="caption-side: top;color: #254756;font-weight: bold;" ></caption>
                                    ...
                                    <tbody>
                                        <tr data-class='<?php echo $row["class"]; ?>' class='<?php echo $row["class"]; ?> all'>
                                                    ...
                                                    <td class="font-12" style="/*background: #e3f2fd;*/"><input type='number' class='form-control' name='form_title' id="daysInput" required minlength='1' maxlength='500' value="" ></td>
