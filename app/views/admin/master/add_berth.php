                                ...
                                <caption style="caption-side: top;color: #254756;font-weight: bold;" ></caption>
                                    <thead class="<?php echo BG_BLUE_GREY; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class="font-12" style="background: #2196f3;">Birth</th>
                                    ...
                                    <tbody>
                                        <tr data-class='<?php echo $row["class"]; ?>' class='<?php echo $row["class"]; ?> all'>
                                                    ...
                                                    <td class="font-12" style="/*background: #e3f2fd;*/"><input type='text' class='form-control' name='form_title' id="berth" required minlength='1' maxlength='500' value="" ></td>
                                                    <td class="font-12" style="/*background: #e3f2fd;*/"><button type="submit" id="submitBerth" class="btn btn-success" name="submit">
                                                     Add Birth
                                                    </button></td>
                                            </tr>
                                    </tbody>
