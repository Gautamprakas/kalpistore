                                        ...
                                        <?php if(count($data)>0){ ?>
                                            <?php $i=0; foreach($data as $row){ ?>
                                                <tr data-class='<?php echo $row["class"]; ?>' class='<?php echo $row["class"]; ?> all'>
                                                    ...
                                                    <td class="font-12" style="background: #e3f2fd;text-transform: capitalize;"><?php echo $row['coach_number'] ; ?></td>
                                                    <td class="font-12" style="background: #e3f2fd;text-transform: capitalize;"><?php echo $row['coach_category'] ; ?></td>
                                                    <td class="font-12" style="background: #e3f2fd;text-transform: capitalize;">
                                                    <select id="coachStatus<?php echo $i; ?>" class="form-control input_type show-tick" name="" data-size="5" data-properties="<?php echo $row['coach_number'] ; ?>" required >
                                                            <option value="">--Select Input Type--</option>
                                                            <option value="0">Block Coach</option>
                                                            <option value="Delete Coach">Delete Coach</option>
                                                            <option value="1">Active Coach</option>
                                                    </select>
