...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        $("#submitCoach").click(function(event){
            ...
            if(CoachNo==""){
                alert("Coach number can't be empty..");
                return;
            }
            if(CoachCat==""){
                alert("Coach category can't be empty..");
                return;
            }
            $.ajax({

                url:'<?php echo base_url("Master/saveCoach"); ?>',
                method:'POST',
                data:{
                    CoachNo:CoachNo,
                    CoachCat:CoachCat,
                ...
                success:function(response){
                    alert(response);
                    window.location.href='<?php echo base_url("Master/addCoach"); ?>';
