                                ...
                                <caption style="caption-side: top;color: #254756;font-weight: bold;" ></caption>
                                    ...
                                    <tbody>
                                        <tr data-class='<?php echo $row["class"]; ?>' class='<?php echo $row["class"]; ?> all'>
                                                    ...
                                                    <td class="font-12" style="/*background: #e3f2fd;*/"><input type='text' class='form-control' name='form_title' id="uom" required minlength='1' maxlength='500' value="" ></td>
                                                    <td class="font-12" style="/*background: #e3f2fd;*/"><button type="submit" id="submitUom" class="btn btn-success" name="submit">
                                                     Add UOM
                                                    </button></td>
                                            </tr>
                                    </tbody>
