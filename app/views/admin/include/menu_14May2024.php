<!--Menu -->
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<?php if(strcasecmp($menuActive, 'home2') == 0) echo 'active'; ?> blink_me">
                        <a href="https://pfms.nic.in/" onclick="//return false;" id="pfms" target="_blank">
                            <i class="material-icons">navigation</i>
                            <span>Go To PFMS</span>
                        </a>
                    </li>
...
<?php if( $this->location_type == "ADMIN" ||  $this->location_type == "DIVISION" ||  $this->location_type == "DISTRICT" ): ?>
                    ...
                    <li class="<?php if(strcasecmp($menuActive, 'sachiv') == 0) echo 'active'; ?>">
                        <a href="<?php echo base_url('Employee/sachivDetails'); ?>" onclick="//return false;">
                            <i class="material-icons">person</i>
                            <span>Sachiv Details</span>
                        </a>
                    </li>
...
<li class="<?php if(strcasecmp($menuActive, 'incidencedetailsSbm') == 0) echo 'active'; ?>">
    <a href="<?php echo base_url('Incidence/incidencedetailsSbm'); ?>" onclick="//return false;">
        <i class="material-icons">equalizer</i>
        <span>SBM/RGSA Entry Report</span>
    </a>
</li>
...
<?php if( $this->location_type == "VILLAGE" ){ ?>
    ...
    <li class="<?php if(strcasecmp($menuActive, 'addIncidence2Sbm') == 0) echo 'active'; ?>">
        <a href="<?php echo base_url('Incidence/addIncidence2Sbm'); ?>" onclick="//return false;">
            <i class="material-icons">account_balance_wallet</i>
            <span><?php echo "UP-Swachh Bharat Mission Gramin (9151) / Rashtriya Gram Swaraj Abhiyan"; ?></span>
        </a>
    </li>
    <?php } ?>
    <?php if( $this->ltn == "2" ){ ?>
...
<?php } ?>
                    ...
                    <li class="<?php if(strcasecmp($menuActive, 'report_links') == 0) echo 'active'; ?> blink_me">
                        <a href="<?php echo base_url('Report/report_links'); ?>">
                            <i class="material-icons">equalizer</i>
                            <span>Outside Gram Sachiwalaya Report</span>
                        </a>
                    </li>
                    <li class="<?php if(strcasecmp($menuActive, 'report_links2') == 0) echo 'active'; ?> blink_me">
                        <a href="<?php echo base_url('Report/report_links2'); ?>">
                            <i class="material-icons">equalizer</i>
                            <span>Analytical Reports</span>
                        </a>
                    </li>
                    <li class="<?php if(strcasecmp($menuActive, 'report_links3') == 0) echo 'active'; ?> blink_me">
                        <a href="<?php echo base_url('Report/report_links3'); ?>">
                            <i class="material-icons">equalizer</i>
                            <span>SBM/RGSA Reports</span>
                        </a>
                    </li>
                    <li class="<?php if(strcasecmp($menuActive, 'report_links_ivrs') == 0) echo 'active'; ?> blink_me">
                        <a href="<?php echo base_url('Report/report_links_ivrs'); ?>">
                            <i class="material-icons">equalizer</i>
                            <span>IVRS Reports</span>
                        </a>
                    </li>
                    <?php } ?>
