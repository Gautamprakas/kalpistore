...
jQuery(document).ready(function(){     
        function initializeMobileTable(){
            $.get("<?php echo base_url("Railway/getWorkDoneActivities"); ?>",function(data){
...
function sanitizeData(jsonArray) {
        ...
        jsonArray.forEach(function(item) {
            item.action=`<span class="font-bold col-teal">Done</span>`;
    ...
    function sanitizeDataMobile(jsonArray) {
        ...
        var newArr=[];
        jsonArray.forEach(function(item) {
            var action="<span class='font-bold col-teal'>Done</span>";
