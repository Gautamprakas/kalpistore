...
//       t_accuracy = localStorage.getItem("t_accuracy");
//       if( !t_accuracy || crd.accuracy <= t_accuracy ){
//         localStorage.setItem('t_latitude', crd.latitude);
//         localStorage.setItem('t_longitude', crd.longitude);
//         localStorage.setItem('t_accuracy', crd.accuracy);
//       }
...
$(document).on('keydown','.pasteonly', function(e) {
  //if( e.keyCode == 8 ){
    $(this).val("");
  //}
...
$(document).on('keyup','.pasteonly', function(e) {
